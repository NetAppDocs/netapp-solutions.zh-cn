...
Amazon FSx ONTAP在AWS云中提供完全托管的共享存储、并具有ONTAP常见的数据访问和管理功能。有关Amazon FSx ONTAP的详细信息，请单击 https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/what-is-fsx-ontap.html["此处"]。
