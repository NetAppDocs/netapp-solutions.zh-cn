...
. 要使用部署Astra控制中心的Ansible攻略手册、您必须安装装有Ansible的Ubuntu或RHEL计算机。按照步骤进行操作 https://docs.netapp.com/us-en/netapp-solutions/automation/getting-started.html["此处"] 适用于Ubuntu和RHEL。
