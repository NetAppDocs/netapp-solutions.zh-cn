...
. 要使用部署Astra控制中心的Ansible攻略手册、您必须安装装有Ansible的Ubuntu或RHEL计算机。请遵循此操作 https://docs.netapp.com/us-en/netapp-solutions/automation/automation_ubuntu_debian_setup.html["操作步骤"^] 适用于Ubuntu和此版本 https://docs.netapp.com/us-en/netapp-solutions/automation/automation_rhel_centos_setup.html["操作步骤"^] 对于 RHEL 。
