...
. 创建一个名为 Jenkins 的新项目。
+
image:redhat_openshift_image15.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
+
image:redhat_openshift_image19.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
+
image:redhat_openshift_image22.jpeg["图中显示了输入/输出对话框或表示已写入内容"]

. 授权 Jenkins 服务帐户访问 OpenShift 用户。
+
image:redhat_openshift_image23.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
...
+
image:redhat_openshift_image25.jpeg["图中显示了输入/输出对话框或表示已写入内容"]
