...
Trident的最新版本是2022年1月发布的22.01。一个支持表，用于说明已使用哪个版本的Trident进行了测试，可以找到Kubbernetes分发 https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["此处"]。
