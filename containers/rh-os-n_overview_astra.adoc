...
.自动化的〔可逆〕
--
. 要使用 Ansible 攻略手册部署 Astra 控制中心，您需要安装安装有 Ansible 的 Ubuntu 或 RHEL 计算机。按照所述按照操作步骤 进行操作 https://docs.netapp.com/us-en/netapp-solutions/automation/automation_ubuntu_debian_setup.html["此处"] 适用于 Ubuntu 和此 对于 RHEL 。
