...
.自动化的〔可逆〕
--
. 要使用Ansible攻略手册部署Astra控制中心、您需要安装安装有Ansible的Ubuntu或RHEL计算机。按照步骤进行操作 https://docs.netapp.com/us-en/netapp-solutions/automation/getting-started.html["此处"] 适用于Ubuntu和RHEL。
