...
有关从vSphere迁移VM的详细信息、请参见link:https://docs.netapp.com/us-en/netapp-solutions/containers/rh-os-n_use_case_openshift_virtualization_workflow_vm_migration_using_mtv.html["工作流 ONTAP的Red Hat OpenShift虚拟化"]
