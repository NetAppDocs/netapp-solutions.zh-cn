...
---
= 借助iSCSI在Amazon FSx ONTAP上简化和自动化Oracle部署
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
----
. 将EC2 Linux实例配置为安装了最新版本的Ansv近 和Git的Ansv可 控制器节点。有关详细信息、请参见以下链接： link:https://docs.netapp.com/us-en/netapp-solutions/automation/getting-started.html["NetApp解决方案 自动化入门"^] 在第-节中
