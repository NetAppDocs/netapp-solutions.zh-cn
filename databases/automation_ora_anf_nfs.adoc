...
[%collapsible]
====
NetApp建议使用SnapCenter UI工具来管理部署在Azure云中的Oracle数据库。请参阅TR-4988： link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["使用SnapCenter在ANF上执行Oracle数据库备份、恢复和克隆"^] 了解详细信息。
...
+
link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["使用SnapCenter在ANF上执行Oracle数据库备份、恢复和克隆"^]
