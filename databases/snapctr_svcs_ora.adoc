...
* 阅读与Oracle和Amazon FSx ONTAP相关的一般说明link:https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-protect-cloud-app-data-to-cloud.html#architecture["保护您的Cloud原生 应用程序数据"^]和章节。
* 观看以下视频演练。
