...
在本文档中、我们将演示如何取消应用程序级别的PostgreSQL流式HA/DR解决方案 、并基于AWS FSX ONTAP 存储构建基于PostgreSQL HA/DR解决方案 、用于存储数据库文件和EC2计算实例、例如PostgreSQL DB服务器。与传统的PostgreSQL应用程序级HA/DR流复制相比、解决方案 可创建一个更简单、更具可比性的系统、并提供同等的结果。
...
NetApp建议使用成熟的操作系统集群软件运行手动故障转移、该软件可能需要许可证。
