...
* 动态服务级别更改目前仍在公有预览中，默认情况下不会启用。要在 Azure 订阅上启用此功能，请参见本文档了解如何操作 https://["动态更改卷的服务级别"^]。
* 中提供了 Azure CLI 卷池更改命令 https://["卷池更改文档"^] 在以下示例中：
+
....
az netappfiles volume pool-change -g mygroup --account-name myaccname --pool-name mypoolname --name myvolname --new-pool-resource-id mynewresourceid
....
* PowerShell ： https://["Set-AzNetAppFilesVolumePool cmdlet"^] 更改 Azure NetApp Files 卷的池，如以下示例所示：
+
....
