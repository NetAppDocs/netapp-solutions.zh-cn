...
* https://["NetApp Pub"^]。NetApp 配置管理和自动化。
* https://["适用于 VMware 的 Ansible GALAXY 社区"^]。一组适用于 VMware 的 Ansible 资源。
* https://["VMware ｛ code ｝ 资源"^]。为软件定义的数据中心设计解决方案所需的资源，包括论坛，设计标准，示例代码和开发人员工具。
