...
* 使用ONTAP工具在VI工作负载域中部署Vvol (iSCSI)数据存储库。单击 https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_vvols.html["*此处*"] 了解部署步骤。
* 配置要在VI工作负载域中使用的基于TCP的NVMe数据存储库。单击 https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_nvme.html["*此处*"] 了解部署步骤。
* 部署并使用适用于VMware vSphere的SnapCenter插件来保护和还原VI工作负载域中的VM。单击 https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_scv_wkld.html["*此处*"] 了解部署步骤。
