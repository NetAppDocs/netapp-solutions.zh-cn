...
link:saphana_aff_fc_architecture.html["先前版本：架构。"]
...
第一个磁盘架至少需要 12 个 NVMe SSD ，最多支持 16 个 SAP HANA 主机。一个完全填充的磁盘架最多可支持 34 个 SAP HANA 主机。
...
image:saphana_aff_fc_image8.jpg["错误：缺少图形映像"]

link:saphana_aff_fc_infrastructure_setup_and_configuration_overview.html["接下来：基础架构设置和配置。"]
