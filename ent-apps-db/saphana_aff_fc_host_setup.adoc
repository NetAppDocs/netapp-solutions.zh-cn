...
link:saphana_aff_fc_sap_hana_storage_connector_api.html["先前版本： SAP HANA 存储连接器 API 。"]
...
link:saphana_aff_fc_i_o_stack_configuration_for_sap_hana.html["接下来： SAP HANA 的 I/O 堆栈配置。"]
