...
与部署的 AFF 系统无关， SAP HANA 环境也可以通过添加任何经过认证的存储控制器来进行扩展，以满足所需的节点密度，如下图所示。
...
image:saphana_aff_fc_image5.jpg["错误：缺少图形映像"]
...
有关 SAP HANA 备份和恢复解决方案的详细信息，请参见 https://www.netapp.com/us/media/tr-4614.pdf["TR-4614 ：《使用 SnapCenter 实现 SAP HANA 备份和恢复》"^]。
...
image:saphana_aff_fc_image6.png["错误：缺少图形映像"]
...
image:saphana_aff_fc_image7.png["错误：缺少图形映像"]

link:saphana_aff_fc_storage_sizing.html["接下来：存储规模估算。"]
