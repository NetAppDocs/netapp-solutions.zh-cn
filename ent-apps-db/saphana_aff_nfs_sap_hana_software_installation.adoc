...
link:saphana_aff_nfs_sap_hana_data_volume_size.html["先前版本： SAP HANA 数据卷大小。"]
...
link:saphana_aff_nfs_adding_additional_data_volume_partitions.html["下一步：添加其他数据卷分区。"]
