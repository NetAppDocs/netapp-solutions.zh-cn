...
. 使用现有VMC SDDC或根据此操作创建新的SDDC https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-setup.html["NetApp链接"^] 或这一点 https://docs.vmware.com/en/VMware-Cloud-on-AWS/services/com.vmware.vmc-aws.getting-started/GUID-EF198D55-03E3-44D1-AC48-6E2ABA31FF02.html["VMware链接"^]。
