...
有关设置SnapCenter 和复制数据的分步说明示例、请参见 https://docs.netapp.com/us-en/netapp-solutions/ehc/aws/aws-guest-dr-overview.html#config-snapmirror["使用SnapCenter 设置复制"]

link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=395e33db-0d63-4e48-8898-b01200f006ca["视频：使用SnapCenter保护SQL VM"]
...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=8b7e4a9b-7de1-4d48-a8e2-b01200f00692["视频：SQL VM的Veeam复制"]

====
.Microsoft SQL Server VM故障转移
[%collapsible]
====
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=9762dc99-081b-41a2-ac68-b01200f00ac0["视频：SQL VM故障转移"]
