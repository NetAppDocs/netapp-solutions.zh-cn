...
. 如果资源提供程序未注册，请选择注册。
+
image::avs-register-create-pc-1.png[AVS寄存器创建PC 1]

+
image::avs-register-create-pc-2.png[AVS寄存器创建PC 2]
...
image::avs-register-create-pc-3.png[AVS寄存器创建PC 3.]
...
image::avs-register-create-pc-4.png[AVS寄存器创建PC 4.]
...
+
image::azure-connect-gateway-1.png[Azure连接网关1]

. 提供或更新新 vNet 的信息，然后选择确定。


image::azure-connect-gateway-2.png[Azure连接网关2.]
...
image::azure-validate-network-1.png[Azure验证网络1]

配置虚拟机后，使用 Connect 选项访问 RDP 。

image::azure-validate-network-2.png[Azure验证网络2.]
...
image::azure-validate-network-3.png[Azure验证网络3]
...
image::azure-validate-network-4.png[Azure验证网络4.]

image::azure-validate-network-5.png[Azure验证网络5.]
