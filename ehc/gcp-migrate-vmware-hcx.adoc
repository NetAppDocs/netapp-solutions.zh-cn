...
* 使用现有Google Cloud VMware Engine软件定义的数据中心(SDDC)或使用此功能创建私有云 https://docs.netapp.com/us-en/netapp-solutions/ehc/gcp-setup.html["NetApp链接"^] 或这一点 https://cloud.google.com/vmware-engine/docs/create-private-cloud["Google链接"^]。
