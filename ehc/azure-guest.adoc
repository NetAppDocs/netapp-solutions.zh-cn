...
+
image::azure-anf-guest-1.png[Azure和子系统1]
...
+
image::azure-anf-guest-2.png[Azure和子系统2]
...
+
image::azure-anf-guest-3.png[Azure和子系统3]

. 使用容量池刀片下的卷刀片添加 SMB 卷。确保在创建 SMB 卷之前已配置 Active Directory 连接器。
+
image::azure-anf-guest-4.png[Azure和子系统4.]
...
+
image::azure-anf-guest-5.png[Azure和子系统5]

+
image::azure-anf-guest-6.png[Azure和子系统6]
...
+
image::azure-anf-guest-7.png[Azure和子系统7]

+
image::azure-anf-guest-8.png[Azure和子系统8.]

. 要在 Azure VMware 解决方案 SDDC 上运行的 Linux VM 上挂载 NFS 卷，请使用相同的过程。使用卷重新调整或动态服务级别功能来满足工作负载需求。
+
image::azure-anf-guest-9.png[Azure和子系统9.]
...
+
image::azure-cvo-guest-22.png[Azure CVO子系统22.]

. 创建卷后，使用 mount 命令从 Azure VMware 解决方案 SDDC 主机上运行的虚拟机连接到共享。
. 复制以下路径并使用映射网络驱动器选项将卷挂载到 Azure VMware 解决方案 SDDC 上运行的虚拟机上。
+
image::azure-cvo-guest-23.png[Azure CVO子系统23.]

+
image::azure-cvo-guest-24.png[Azure CVO子系统24]
...
+
image::azure-cvo-guest-30.png[Azure CVO子系统30.]
...
+
image::azure-cvo-guest-31.png[Azure CVO子系统31]
...
image::azure-cvo-guest-32.png[Azure CVO子系统32.]
...
image::azure-cvo-guest-33.png[Azure CVO子系统33]

image::azure-cvo-guest-34.png[Azure CVO子系统34]
