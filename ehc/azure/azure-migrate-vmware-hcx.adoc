...
要了解有关此过程的更多信息、请随时访问 link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=255640f5-4dff-438c-8d50-b01200f017d1["观看详细的演示视频"]。

下面是HCX vMotion选项的屏幕截图。

image:anfd-hcx-image20.png["错误：缺少图形映像"]

要了解有关此过程的更多信息、请随时访问 link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=986bb505-6f3d-4a5a-b016-b01200f03f18["观看详细的演示视频"]。
