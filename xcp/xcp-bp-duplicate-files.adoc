...
link:xcp-bp-using-the-xcp-data-mover-to-migrate-large-files.html["先前版本：使用 XCP 数据移动器迁移大型文件。"]
...
....
link:xcp-bp-specific-date-based-scan-and-copy-of-data.html["下一步：基于日期的特定数据扫描和复制。"]
