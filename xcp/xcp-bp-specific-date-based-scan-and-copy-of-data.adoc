...
summary: 此解决方案基于需要根据特定日期复制数据的客户。 
---
= 基于日期的特定数据扫描和复制
:hardbreaks:
:allow-uri-read: 
...
link:xcp-bp-duplicate-files.html["上一步：重复文件。"]

此解决方案基于需要根据特定日期复制数据的客户。验证以下详细信息：
...
c:\XCP>
....
link:xcp-bp-creating-a-csv-file-from-smb-cifs-share.html["下一步：从 SMB/CIFS 共享创建 CSV 文件。"]
