...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["每个主机部署有双存储网络结构(两个HBA或iSCSI的双VLAN)的VMware vSphere主机"](英文)
...
* link:vmware_vcf_asa_supp_mgmt_iscsi.html#deployment-steps["Storage VM和SVM均可用"]
