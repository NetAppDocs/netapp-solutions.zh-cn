...
* link:https://docs.netapp/com/us-en/vontap-apps-dbs/vmware/vmware-vsphere-overview.html["NetApp ONTAP支持所有存储协议"]
...
* link:https://docs.netapp.com/us-en/ntap-apps-dbs/vmware/vmware-srm-overview.html["采用 NetApp ONTAP 9 的 VMware Site Recovery Manager"]
