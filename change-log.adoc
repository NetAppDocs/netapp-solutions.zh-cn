...
| 2021 年 3 月 1 日 | 容器 | 在 NVA-1160 中增加了新的章节：通过 OperatorHub 和 Ansible 安装 Astra 控制中心 
...
| 2021 年 6 月 12 日 | 混合云 / 虚拟化 | 为虚拟化环境和子系统连接存储选项创建企业混合云（ Enterprise Hybrid Cloud ， EHC ）内容 
