...
* link:https://bluexp.netapp.com/blog/aws-fsxn-blg-migrate-vmware-to-amazon-ec2-iscsi-based-fsx-for-ontap["使用Amazon EC2和Amazon FSx for NetApp ONTAP iSCSI协议将VMware VM迁移到AWS"]
