...
link:confluent-kafka-performance-tests-with-scalability.html["上一篇：性能测试与可扩展性。"]
...
root@stlrx2540m1-108:~#
....
. 要打印记录，请使用 avro-tools-1.11.0.1.jar （可在中找到 http://["Apache 归档"^]）。
+
....
...
link:confluent-kafka-confluent-kafka-rebalance.html["接下来：融合自重新平衡集群。"]
