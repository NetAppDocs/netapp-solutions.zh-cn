...
link:apache-spark-hybrid-cloud-solution.html["先前版本：混合云解决方案。"]

以下三个Python脚本对应于所测试的三个主要用例。第一个是`sentiment_analysis _sparknlp.py`。
...
....
link:apache-spark-conclusion.html["接下来：总结。"]
